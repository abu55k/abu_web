...
<body>
    <div class="app-container">
        <h1>MoneTag Auto Ads</h1>
        <div class="developer">MR UNKNOWN</div>
...
<script src='//niphaumeenses.net/vignette.min.js' data-zone='8702752' data-sdk='show_8702752'></script>
    <script>
        let watchedAds = 0;
        let earnedPoints = 0;
        ...
        function showAd() {
            if (typeof show_8578473 === 'function') {
                show_8578473().then(() => {
                    watchedAds++;
